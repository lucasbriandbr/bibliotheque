            ...
            <div className={`flex flex-row h-[100%] w-full bg-white`}>
                ...
                <div className={`flex flex-col h-full w-full p-8 items-center justify-center`}>
                    ...
                    <div className={`h-full md:w-1/2 lg:w-1/2 items-center justify-center`}>                        
                        ...
                        <input type="text" id='Email1' className="block w-full text-gray-900 rounded-lg border-[1px] border-black text-sm px-5 py-2.5 mt-4 focus:outline-none" placeholder='Mail' required onChange={()=>{setMail1(document.getElementById('Email1').value)}} value={mail1.toLowerCase()}/>
                        ...
                        <input type="text" id='Email2' className="block w-full text-gray-900 rounded-lg border-[1px] border-black text-sm px-5 py-2.5 mt-4 focus:outline-none" placeholder='Mail' required onChange={()=>{setMail2(document.getElementById('Email2').value)}} value={mail2.toLowerCase()}/>
                        <input type="text" id='Name' className="block w-full text-gray-900 rounded-lg border-[1px] border-black text-sm px-5 py-2.5 mt-4 focus:outline-none" placeholder='Name' required onChange={()=>{setName(document.getElementById('Name').value)}} value={name.toLowerCase()}/>
