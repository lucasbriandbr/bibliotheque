        ...
        <>
            <nav className={`bg-white dark:bg-[#faebd7] border-b-[1px] border-black`}>
                <div className={`flex flex-wrap justify-between items-center mx-auto`}>
                    ...
                    :
                    <button type="button" className={`inline-flex items-center p-[15px] border-l-[1px] border-black ml-3 text-sm text-black hover:bg-white focus:outline-none dark:text-black`} aria-controls="mobile-menu" aria-expanded="false">
