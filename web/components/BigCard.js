    ...
    return(
        <Link href={`/book/${sku}`}>
            <a className={`relative flex items-end text-black rounded-lg min-h-[20vh] min-w-[5vw]`}>
                ...
                <img src={src} alt={`Une couverture de livre`} className={`flex absolute bottom-4 left-4 self-start justify-self-start h-full w-auto border border-black rounded-lg`}/>

                <div className="static grid grid-cols-2 bg-blue-300 w-full rounded-lg h-2/3">
